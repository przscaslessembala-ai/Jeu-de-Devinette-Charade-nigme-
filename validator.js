/* ============================================================
   validator.js — Validation intelligente des réponses via Claude API
   Appelé par game.js : await validateWithAI(userAnswer, expectedAnswer)
   ============================================================ */
...
/**
 * Valide la réponse du joueur via Claude API.
 * Retourne true si la réponse est correcte ou très proche, false sinon.
 * En cas d'erreur réseau, retombe sur la validation locale.
 *
 * @param {string} userAnswer     - Ce que le joueur a tapé
 * @param {string} expectedAnswer - La réponse attendue
 * @returns {Promise<boolean>}
 */
async function validateWithAI(userAnswer, expectedAnswer) {
...
/**
 * Validation locale de secours (si l'API est inaccessible).
 * Tolérance étendue : mots-clés, inclusion, Levenshtein.
 */
function localFallback(userAnswer, expectedAnswer) {
